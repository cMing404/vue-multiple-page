...
!function t(e, r, n) {
    ...
    2: [function(t, e, r) {
        ...
        c = t("./utils"),
        s = c.detectIE() || 0 / 0,
        9 > s ? t("json2") : (window.MutationObserver = t("mutation-observer"),
        a = t("tree-mirror")),
        u = t("./info"),
        c = t("./utils"),
        ...
        n = function() {
            ...
            var e, r, n, s, f, p, g, v, m, w, b, y, O, C, N, x, S, E;
            return s = null,
            N = 3,
            p = [],
            r = {},
            ...
            t.prototype.setPageGroup = function(t) {
                return r.pg = t,
                this.pageLoaded && +Date.now() - this.pageLoaded < 4e3 ? setTimeout(function(e) {
                    return function() {
                        var r;
            ...
            t.prototype.trackCS1 = function(t, e) {
                ...
                t && e && this.gruser ? this.gruser.hasSid() ? (this.gruser.isNeedToUpdateSessionByCS(window.vds.accountId) && (this.pageLoaded = +Date.now()),
                this.gruser.handleCSChanged(window.vds.accountId),
                setTimeout(function(t) {
                    return function() {
                        return r = f,
                        +Date.now() - t.pageLoaded > 1e4 ? t.trackPageView(4) : t.trackPageView()
                    }
                }(this), 10)) : (this.pageLoaded = +Date.now(),
                void this.trackPageView(2)) : void 0
            }
            ,
            t.prototype.registerDomObserver = function() {
                var t;
                if (window.vds.imp)
                    return null != s && s.disconnect(),
                    t = {
                        initialize: function(t) {
                            return function(e) {
                                ...
                                o = e.length; o > i; i++)
                                    r = e[i],
                                    n = n.concat(t.getLeafNodes(r, e.length));
                                return a.e = n,
                                t.send([a])
                            }
                        }(this),
                        applyChanged: function(t) {
                            return function(e, r, n, i) {
                                ...
                                if (r.length > 0 && !document.body.className.match(/\bvds-entrytext\b/)) {
                                    for (t.gruser.hasSid() || (t.pageLoaded = +Date.now(),
                                    t.trackPageView(2)),
                                    u = {
                                        u: t.gruser.vid(),
                                        s: t.gruser.sid(),
                                    ...
                                    t.currentQuery.length > 0 && (u.q = t.currentQuery),
                                    t.setPSForActionMessage(u),
                                    o = [],
                                    a = 0,
                                    s = r.length; s > a; a++)
                                        d = r[a],
                                        o = o.concat(t.getLeafNodes(d, d.length));
                                    if (u.e = o,
                                    o.length > 0)
                                        return p.push(u),
                                        0 > N ? t.sendQueue() : (t.queueTimeout && clearTimeout(t.queueTimeout),
                                        t.queueTimeout = setTimeout(function() {
                                            return t.sendQueue()
                                        }, 3e3),
                                        t.checkingBlance())
                                }
            ...
            t.prototype.sendQueue = function() {
                return p.length > 0 && +Date.now() - this.lastActionTime < 12e4 && this.send(p),
            ...
            t.prototype.getLeafNodes = function(t, e) {
                ...
                d = !0,
                t.leaf)
                    1 === t.nodeType && ((null != (h = t.attributes) ? h.href : void 0) || null != t.text || null != t.obj) && (s = this.nodeMessage(t, !0),
                    e > 1 && (s.idx = t.idx),
                    o.push(s));
                else if (0 === t.childNodes.length && -1 === c.indexOf(C, t.tagName))
                    ;
                else {
                    for (l = t.childNodes,
                    i = 0,
                    ...
                    (-1 !== c.indexOf(b, t.tagName) || d && ((null != (f = t.attributes) ? f.any : void 0) || t.text)) && (t.text || (n = t.dom,
                    t.text = n ? u.containerElemContent(n) : c.parentOfLeafText(t)),
                    s = this.nodeMessage(t, !1),
                    o.push(s))
                }
                return o
            }
            ...
            t.prototype.nodeMessage = function(t, e) {
                ...
                (r = t.attributes) && r.href && 0 !== r.href.indexOf("javascript") && (n.h = c.normalizePath(r.href.slice(0, 320)),
            ...
            t.prototype.registerEventListener = function() {
                ...
                i = function() {
                    ...
                    v = n ? ["touchstart"] : ["mousedown"],
                    m = n ? ["touchend", "touchcancel"] : ["mouseup", "mouseleave"],
                ...
                a = function(t) {
                    return function(r) {
                        ...
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            ...
                            d = r.target || r.srcElement; d && 1 === E[d.tagName] && d.parentNode; )
                                d = d.parentNode;
                            if (n = u.path(d, !0),
                            n.isIgnore)
                                return;
                            ...
                            "click" === r.type) {
                                if (-1 !== c.indexOf(e, a))
                                    return;
                                if ("INPUT" === a && -1 === c.indexOf(O, d.type))
                                    return;
                                if (-1 === c.indexOf(C, a) && !u.depthInside(d, 4))
                                    return
                            }
                            return t.gruser.hasSid() || (t.pageLoaded = +Date.now(),
                            t.trackPageView(2)),
                            o = {},
                            o.u = t.gruser.vid(),
                            o.s = t.gruser.sid(),
                            ...
                            o.e = 0 === n.containerMessage.length ? [i] : -1 !== c.indexOf(b, n.pnode.tagName) && u.onlyContainsChildren(n.pnode, w) ? n.containerMessage : [i].concat(n.containerMessage),
                            t.send([o])
                        }
                    }
                }(this);
            ...
            t.prototype.trackPageView = function(t) {
                ...
                return null == t && (t = 0),
                e = [],
                3 !== t || null != r.pg ? 4 !== t || (this.pageLoaded = +Date.now(),
                this.gruser.hasSid()) ? (3 > t && e.push(this.visitMessage()),
                null == this.pageLoaded && (this.pageLoaded = +Date.now()),
                2 === t && (r = f),
                n = this.pageMessage(),
                e.push(n),
                this.send(e, "pv"),
                this.lastActionTime = +Date.now()) : void this.trackPageView(2) : void 0
            }
            ,
            ...
            t.prototype._track = function(t, e, r, n) {
                ...
                this.currentQuery.length > 0 && (h.q = this.currentQuery),
                v = {},
                i = [];
                for (p in n)
            ...
            t.prototype.compute = function(t, e) {
                var r, n, i, o, a, s, d, h, l, f, p, g, v, w, y, C, N, x, S, E;
                if (n = {},
                S = e.tagName,
                "IMG" === S ? (null != (C = e.src) ? C.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (n.h = e.src) : c.hasAttr(e, "href") && (i = e.getAttribute("href"),
                i && 0 !== i.indexOf("javascript") && (n.h = c.normalizePath(i.slice(0, 320)))),
                c.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0)
                    n.v = e.getAttribute("data-growing-title");
                else if (c.hasAttr(e, "title") && e.getAttribute("title").length > 0)
                    n.v = c.processText(e.getAttribute("title"));
                else if ("click" === t)
                    if (u.isLeaf(e))
                        if ("IMG" === S)
                            e.alt ? n.v = e.alt : n.h && (s = n.h.split("?")[0],
                            a = s.split("/"),
                            a.length > 0 && (n.v = a[a.length - 1]));
                        else if ("INPUT" === S && -1 !== c.indexOf(O, e.type))
                            n.v = c.processText(e.value);
                        else if ("svg" === S)
                            for (N = e.childNodes,
                            o = 0,
                            w = N.length; w > o; o++)
                            ...
                            E = "",
                            null != e.textContent ? E = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (E = e.innerText.replace(/[\n \t]+/g, " ").trim()),
                            E.length > 0 && (E.length < 50 ? n.v = c.processText(E) : "A" === S && (n.v = c.processText(E.slice(0, 50))));
                    else
                        -1 !== c.indexOf(b, S) ? n.v = u.containerElemContent(e) : u.isParentOfLeaf(e) && (n.v = c.parentOfLeafText(e));
                else if ("change" === t)
                    "TEXTAREA" !== S && ("INPUT" === S ? -1 !== c.indexOf(m, e.type) ? (n.v = c.processText(e.value),
                    l = e.parentNode,
                    "LABEL" === l.tagName ? h = l : "BODY" !== l.tagName && (l = l.parentNode,
                    "LABEL" === l.tagName ? h = l : e.id && (v = l.getElementsByTagName("label"),
                    function() {
                        var t, r, n;
                        for (n = [],
                        t = 0,
                    ...
                    null != h && (f = u.containerElemContent(h),
                    (null != f ? f.length : void 0) > 0 && (n.obj = f + " (" + e.checked + ")"))) : "password" !== e.type && (c.hasAttr(e, "growing-track") || c.hasAttr(e, "data-growing-track")) && (n.v = c.processText(e.value)) : "SELECT" === S && (n.v = c.processText(e.value),
                    1 === e.selectedOptions.length && null != e.selectedOptions[0].label && (n.obj = e.selectedOptions[0].label)));
                else if ("submit" === t)
                    for (x = e.getElementsByTagName("input"),
                    p = 0,
                    y = x.length; y > p; p++)
                        d = x[p],
                        ("search" === d.type || "text" === d.type && ("q" === d.id || -1 !== d.id.indexOf("search") || -1 !== d.className.indexOf("search") || "q" === d.name || -1 !== d.name.indexOf("search"))) && (n.x = u.path(d).xpath,
                        n.v = c.processText(d.value.trim()));
                return n
            }
            ,
            t.prototype.registerCircleHandler = function() {
                ...
                try {
                    if (!this.messagingObserver)
                        return this.messagingObserver = new i,
                        this.messagingObserver.sendPageLoad(f)
                } catch (e) {
                    t = e
                }
            }
            ...
            t.prototype.registerHistoryHandler = function() {
                ...
                null != t && (this.prevUrl = document.referrer,
                c.bind(window, "popstate", this.pageChanged, !0)),
            ...
            t.prototype.pageChanged = function() {
                ...
                null != (r = this.messagingObserver) ? r.sendPageLoad(f) : void 0) : void 0
            }
            ,
            ...
            t.prototype.blind = function() {
                var t;
                return t = !1,
                window.vds.sampling && (window.vds.sampling_func.call(this) || (t = !0)),
                t
            }
            ,
            ...
            t.prototype.observe = function(t, e) {
                ...
                if (this.send = e,
                this.currentPath = c.path(),
                this.currentQuery = c.query(),
                window.history.pushState && this.registerHistoryHandler(),
                this.trackPageView(),
                document.addEventListener)
                    "interactive" === document.readyState || "complete" === document.readyState ? this.domLoadedHandler() : c.bind(document, "DOMContentLoaded", function(t) {
                        return function() {
    ...
    5: [function(t, e, r) {
        ...
        i = function() {
            function t(t) {
                ...
                p.hasAttr(t, "id") && null === t.getAttribute("id").match(/^[0-9]/) && (this.id = t.getAttribute("id")),
                this.isIgnore = p.hasAttr(t, "growing-ignore") || p.hasAttr(t, "data-growing-ignore"),
                p.hasAttr(t, "href") && (e = t.getAttribute("href"),
                e && 0 !== e.indexOf("javascript") && (this.href = p.normalizePath(e.slice(0, 320)))),
                p.hasAttr(t, "data-growing-info") && (this.grObj = t.getAttribute("data-growing-info")),
                p.hasAttr(t, "data-growing-idx") && (this.grIdx = parseInt(t.getAttribute("data-growing-idx"))),
                "input" === this.name && p.hasAttr(t, "name") && t.getAttribute("name") ? this.klass = [t.getAttribute("name")] : (r = null != (n = p.getKlassName(t, d)) ? n.replace(o, "").trim() : void 0,
        ...
        n = function() {
            ...
            return t.prototype.cookieDomain = function() {
                ...
                if (!this.grCookieDomains)
                    try {
                        ...
                        this.grCookieDomains = 0 <= (e = t[t.length - 1]) && 255 >= e ? [window.location.hostname] : ["." + t.slice(-2).join("."), "." + t.slice(-3).join(".")]
                    } catch (r) {
            ...
            t.prototype.vid = function() {
                return null != this.userId ? this.userId : (this.userId = a.getItem("gr_user_id"),
                this.userId || (this.userId = u(),
                a.setItem("gr_user_id", this.userId, 94608e3, "/", this.cookieDomain())),
                this.userId)
            }
            ,
            t.prototype.hasSid = function() {
                var t, e;
                return e = +Date.now(),
                null != this.sessionId && null != this.lastUpdated && e - this.lastUpdated < 9e5 ? !0 : (t = a.getItem("gr_session_id_" + window.vds.accountId),
                t && t === this.lastSessionId)
            }
            ,
            t.prototype.sid = function() {
                var t;
                return t = +Date.now(),
                null != this.sessionId && null != this.lastUpdated && t - this.lastUpdated < 6e4 ? this.sessionId : (this.sessionId = this._currentSessionId(),
                this.sessionId || (this.sessionId = u()),
            ...
            t.prototype.updateSessionId = function(t, e) {
                return null == e && (e = window.vds.accountId),
                a.setItem("gr_session_id_" + e, t, 1800, "/", this.cookieDomain()),
                this.bindCS1WithSession(t)
            }
            ,
            t.prototype.bindCS1WithSession = function(t) {
                return null == t && (t = this.sessionId),
                window.grcs.cs1 ? a.setItem("gr_cs1_" + t, window.grcs.cs1, 1800, "/", this.cookieDomain()) : void 0
            }
            ,
            t.prototype.handleCSChanged = function(t) {
                return this.isNeedToUpdateSessionByCS(t) ? (this.sessionId = u(),
                this.updateSessionId(this.sessionId, t)) : void 0
            }
            ,
            t.prototype.isNeedToUpdateSessionByCS = function(t) {
                var e, r;
                return r = this._currentSessionId(t),
                e = this._currentSessionBindedCS1(r),
                r && r.trim().length > 0 && window.grcs.cs1 && e && e !== window.grcs.cs1
            }
            ,
            t.prototype._currentSessionId = function(t) {
                return null == t && (t = window.vds.accountId),
                a.getItem("gr_session_id_" + t)
            }
            ,
        ...
        c = {
            ...
            path: function(t, e) {
                var r, n, o, a, s, u, d, c, h, l, g, v, m, w, b, y, O, C, N;
                if (null == e && (e = !1),
                a = "",
                g = !1,
                n = {},
                ...
                c || (r.hasIdx() ? (c = !0,
                u = r.grIdx) : (N = r.path(),
                (-1 !== N.indexOf("/dl") || -1 !== N.indexOf("/tr") || -1 !== N.indexOf("/li")) && (c = !0,
                u = this.index(r.node)))),
                b = r.node.parentNode,
                e && "" !== a && (-1 !== p.indexOf(f, r.node.tagName) || r.isContainer()) && (h ? n.obj = d : p.hasAttr(r.node.parentNode, "data-growing-info") && (n.obj = r.node.parentNode.getAttribute("data-growing-info")),
                n.x = s,
                o.push(n)),
                a = m + a,
                s++,
            ...
            index: function(t) {
                var e, r, n, i, o, a, s;
                for (o = t; o && "BODY" !== o.tagName && -1 === p.indexOf(h, o.tagName); )
                    o = o.parentNode;
                if (o)
                    for (a = o.parentNode,
                    r = 1,
                    ...
                    n = s.length; n > e; e++)
                        if (i = s[e],
                        i.tagName === o.tagName) {
                            if (p.hasAttr(i, "data-growing-idx") && (r = parseInt(i.getAttribute("data-growing-idx"))),
                            i === o)
                                return r;
                            r += 1
                        }
            ...
            depthInside: function(t, e, r) {
                ...
                t.hasChildNodes()) {
                    ...
                    i = a.length; i > n; n++)
                        if (o = a[n],
                        1 === o.nodeType && !c.depthInside(o, e, r + 1))
                            return !1
                }
                return e >= r
            },
            onlyContainsChildren: function(t, e) {
                ...
                i = o.length; i > n; n++)
                    if (r = o[n],
                    -1 === p.indexOf(e, r.tagName))
                        return !1;
                return !0
            },
            containerElemContent: function(t) {
                var e;
                if (p.hasAttr(t, "data-growing-title") && t.getAttribute("data-growing-title").length > 0)
                    return t.getAttribute("data-growing-title");
                if (p.hasAttr(t, "title") && t.title.length > 0)
                    return p.processText(t.getAttribute("title"));
                if ("BUTTON" === t.tagName) {
                    if (t.name.length > 0)
                        return t.name;
                    if (c.onlyContainsChildren(t, l) && null != t.textContent && (e = t.textContent.replace(/[\n \t]+/g, " ").trim(),
                    e.length > 0 && e.length < 50))
                        return p.processText(e)
                } else if ("A" === t.tagName) {
                    if (c.onlyContainsChildren(t, l) && null != t.textContent) {
                        if (e = t.textContent.replace(/[\n \t]+/g, " ").trim(),
                        e.length > 0)
                            return p.processText(e.length <= 50 ? e : e.slice(0, 50))
                    } else if (p.hasAttr(t, "href") && t.getAttribute("href").length > 0)
    ...
    6: [function(t, e, r) {
        ...
        a = function() {
            ...
            try {
                if (null != w[r])
                    return w[r].apply(w, t);
                if (null != c[r])
                    return c[r].apply(c, t)
            } catch (n) {
                return e = n,
                console.error(e)
            }
        ...
        !window.vds || !window.vds.origin) {
            for (null == window._vds && (window._vds = [["setAccountId", "22222-22222-22222-22222"]]),
            g = window._vds,
            f = 0,
            p = g.length; p > f; f++)
                s = g[f],
    ...
    7: [function(t, e, r) {
        ...
        n = function() {
            function t() {
                ...
                this.notifyInnerIframes = s(this.notifyInnerIframes, this),
            ...
            return t.prototype.bindEvents = function() {
                return a.bind(window, "message", function(t) {
                    return function(e) {
                        var r, n, i, s, d, c, h, l;
                        if (n = e.data,
                        n.ai === window.vds.accountId && (c = n.mode || n.circleMode,
                        t.isSdkEvent(c) && (!n.fsna || "sdk" === n.fsna))) {
                            if ("grcw-inner-iframe" === n.sna)
                                return void parent.postMessage(e.data, "*");
                            if (h = n.mode,
                            u.call(o, h) >= 0)
                                a.spreadToInnerIframes(n);
                            else if (n.tna !== window.grSource.name && n.tna && n.tid) {
                                for (r = document.getElementsByTagName("iframe"),
                                i = 0,
                                d = r.length; d > i; i++)
                                    s = r[i],
                                    t.notifyInnerIframes(s, n);
                                return
                            }
                            if (l = n.mode,
                            u.call(o, l) >= 0 || n.tna === window.grSource.name || e.origin === window.vds.origin || -1 !== a.indexOf(["www.growingio.com", "growingio.com"], e.origin.split("://")[1]))
            ...
            t.prototype.sendPageLoad = function(t) {
                ...
                n = (null != (r = window.vds) ? r.pathCaseSensitive : void 0) ? window.location.toString() : window.location.toString().toLowerCase(),
                e = {
                ...
                this.pluginLoaded ? setTimeout(function() {
            ...
            t.prototype.loadPlugin = function() {
                ...
                i = o.length; i > n; n++)
                    ...
                    null != a && -1 !== a.indexOf("/circle-plugin.js")) {
                        this.pluginLoaded = !0;
                        break
                    }
                return this.pluginLoaded ? void 0 : (t = document.createElement("script"),
                t.type = "text/javascript",
                t.charset = "UTF-8",
                t.src = this.allowOrigin + "/assets/javascripts/circle-plugin.js",
                document.head.appendChild(t),
                e = document.createElement("link"),
                e.rel = "stylesheet",
                e.href = this.allowOrigin + "/assets/stylesheets/circle-plugin.css",
            ...
            t.prototype.startCircle = function() {
                ...
                if (!this.pluginLoaded)
                    for (n = document.getElementsByTagName("script"),
                    e = 0,
                    r = n.length; r > e; e++)
                        if (t = n[e],
                        i = t.getAttribute("src"),
                        null != i && -1 !== i.indexOf("/circle-plugin.js")) {
                            this.pluginLoaded = !0;
                            break
                        }
            ...
            t.prototype.publishCircle = function() {
                return "undefined" != typeof CircleEvents && null !== CircleEvents ? (CircleEvents.publish("circle:start"),
                this.registerInnerIframe()) : setTimeout(function(t) {
                    return function() {
    ...
    8: [function(t, e, r) {
        ...
        i = function() {
            ...
            t.prototype.send = function(t, e) {
                ...
                null == e && (e = "action");
                try {
                    return r = "undefined" == typeof Uint8Array || null === Uint8Array || s ? window.XMLHttpRequest && 7 !== a && !s ? u.compressToUTF16(JSON.stringify(t)) : u.compressToEncodedURIComponent(JSON.stringify(t)) : u.compressToUint8Array(JSON.stringify(t)),
                    this.sendRemote(r, e)
                } catch (i) {
                    n = i
                }
            ...
            t.prototype.sendRemote = function(t, e) {
                ...
                window.XMLHttpRequest && 7 !== a && !s) {
                    if (o = new XMLHttpRequest,
                    "withCredentials"in o)
                        return o.open("POST", d + "?stm=" + +Date.now(), !0),
                        o.withCredentials = !0,
                        o.onreadystatechange = function(t) {
                            return function() {
                                return 4 === o.readyState ? (t.removeAjax(o),
                                window.grWaitTime = +Date.now() + 10) : void 0
                            }
                        }(this),
                    ...
                    if ("undefined" != typeof XDomainRequest)
                        ...
                        "http:" === document.location.protocol && (d = d.replace("https://", "http://")),
                        o.open("POST", d + "?stm=" + +Date.now()),
                        o.onload = function(t) {
                            return function() {
                        ...
                        o.send(t),
                        i.push(o)
                } else if ("http:" === document.location.protocol && (d = d.replace("https://", "http://")),
                u = d + "?data=" + t + "&stm=" + +Date.now(),
                u.length <= 2036)
                    return this.imgSend(u)
            }
            ,
            ...
            t.prototype.imgSend = function(t) {
                ...
                e.width = 1,
                e.height = 1,
                e.onload = e.onerror = e.onabort = function(t) {
                    return function() {
    ...
    11: [function(t, e, r) {
        ...
        i = function() {
            ...
            t.prototype.connect = function(t) {
                ...
                if (a = window.navigator.userAgent.toLowerCase(),
                a.match(/(bot|crawler|spider|scrapy|jiankongbao|slurp|transcoder|networkbench|oneapm)/i)) {
                    if (!this.properties.bot)
                        return;
                    window.vds.imp = !1,
                    r = !0
                }
                return o = new n(this.user,this.getUrlMap(),t),
                o.connect({
                    isBot: !!r
                })
            }
    ...
    12: [function(t, e, r) {
        ...
        i = {
            ...
            getWindowSourceName: function() {
                var t, e;
                return e = null != window.self.name ? window.self.name : window.name,
        ...
        var n = /^(\.co\.|\.com\.|\.org\.|\.edu\.|\.net\.)/
          , i = {
            ...
            removeItem: function(t, e, r) {
                return this.hasItem(t) ? (document.cookie = encodeURIComponent(t) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT" + (r ? "; domain=" + r : "") + (e ? "; path=" + e : ""),
                !0) : !1
            },
            hasItem: function(t) {
    ...
    16: [function(t, e, r) {
        ...
        ;
        if (s = "undefined" != typeof WebKitMutationObserver ? WebKitMutationObserver : MutationObserver,
        void 0 === s)
        ...
        var h = function() {
                ...
                if (!this.visited.has(t)) {
                    ...
                    n !== d.STAYED_OUT) {
                        ...
                        n === d.ENTERED)
                            ...
                            var i = d.STAYED_IN;
                            r && r.childList && (r.oldParentNode !== t.parentNode ? (i = d.REPARENTED,
                            this.ensureHasOldPreviousSiblingIfNeeded(t)) : this.calcReordered && this.wasReordered(t) && (i = d.REORDERED)),
                    ...
                    if (u.attributes && d.STAYED_IN === this.treeChanges.reachabilityChange(s) && d.STAYED_IN === this.matchabilityChange(s))
                        for (var c = s, h = u.getAttributeNamesMutated(), l = 0; l < h.length; l++) {
                            ...
                            if (!e || e[i] || u.isCaseInsensitive && r[i]) {
                                ...
                                f !== c.getAttribute(i) && (r && u.isCaseInsensitive && (i = r[i]),
                                o[i] = o[i] || [],
                                o[i].push(c))
                            }
                        }
                    ...
                    for (var e = 0; e < this.mutations.length; e++) {
                        ...
                        if ("childList" == r.type && (this.treeChanges.reachabilityChange(r.target) === d.STAYED_IN || this.calcOldPreviousSibling)) {
                            for (var n = this.getChildlistChange(r.target), i = r.previousSibling, o = 0; o < r.removedNodes.length; o++) {
                                ...
                                t(a, i),
                                n.added.has(a) ? n.added["delete"](a) : (n.removed.set(a, !0),
                                n.maybeMoved["delete"](a)),
                                i = a
                            }
                            t(r.nextSibling, i);
                            for (var o = 0; o < r.addedNodes.length; o++) {
                                var a = r.addedNodes[o];
                                n.removed.has(a) ? (n.removed["delete"](a),
                                n.maybeMoved.set(a, !0)) : n.added.set(a, !0)
                            }
                        }
                    }
                }
            ...
            t.prototype.wasReordered = function(t) {
                function e(t) {
                    ...
                    if (!a.maybeMoved.has(t))
                        return !1;
                    var e = a.moved.get(t);
                    return void 0 !== e ? e : (s.has(t) ? e = !0 : (s.set(t, !0),
                    e = n(t) !== r(t)),
                    s.has(t) ? (s["delete"](t),
                    a.moved.set(t, e)) : e = a.moved.get(t),
                    e)
                }
                function r(t) {
                    var n = u.get(t);
          ...
          , b = function() {
            ...
            t.parseSelectors = function(e) {
                ...
                for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3, f = 4, p = 5, g = 6, b = 7, y = 8, O = 9, C = 10, N = 11, x = 12, S = 13, E = 14, A = c, I = 0; I < e.length; ) {
                    var T = e[I++];
                    switch (A) {
                    case c:
                        if (T.match(v)) {
            ...
            t.validateOptions = function(e) {
                ...
                for (var n = {
                    ...
                    if (s.all) {
                        ...
                        if (s.hasOwnProperty("elementAttributes") && (u.attributeList = o(s.elementAttributes),
                        d--),
                        d > 1)
    ...
    , {}],
    17: [function(t, e, r) {
        window.MutationSummary = t("mutation-summary");
        var n = {
            SCRIPT: 1,
            STYLE: 1,
            NOSCRIPT: 1,
                ...
                case 1:
                    ...
                    w.childNodes.length > 0) {
                        ...
                        w.hasAttribute("growing-ignore") || w.hasAttribute("data-growing-ignore"))
                            return null;
                        var O, C, N = 0, x = -1 !== u.indexOf(w.tagName);
                        if (x)
                            for (var S = w.firstChild; S; S = S.nextSibling)
                                if (1 === S.nodeType && -1 === s.indexOf(S.tagName)) {
                                    x = !1;
                                    break
                                }
                        for (var E = w.firstChild; E; E = E.nextSibling) {
                            if (O = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null,
                            C = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1,
                            1 === E.nodeType) {
                                if (1 === n[E.tagName])
                                    continue;
                                if (E.hasAttribute("growing-ignore") || E.hasAttribute("data-growing-ignore"))
                                    continue;
                                if (x && -1 !== s.indexOf(E.tagName)) {
                                    y = !1;
                                    continue
                                }
                                -1 !== i.indexOf(E.tagName) && (N += 1,
                                C = N),
                                E.hasAttribute("data-growing-idx") && (N = parseInt(E.getAttribute("data-growing-idx")),
                                C = N),
                                E.hasAttribute("data-growing-info") && (O = E.getAttribute("data-growing-info"))
                            }
                            var A = this.serializeNode(E, e, N > 0 && C > 0 ? N : r, O || d);
                            if (null === A)
                                3 != E.nodeType && (y = !1);
                    ...
                    if (y)
                        ...
                        w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0)
                        ...
                        } else if ("INPUT" === w.tagName && -1 !== a.indexOf(w.type))
                            g.text = w.value;
                            ...
                            if (0 === _.length && "I" !== w.tagName && "A" !== w.tagName)
                                return null;
                            g.text = _
                        }
                    else
                        w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0 ? g.text = w.getAttribute("data-growing-title") : w.hasAttribute("title") && w.getAttribute("title").length > 0 && (g.text = w.getAttribute("title")),
